...
class LiftProject(info: ProjectInfo) extends DefaultWebProject(info) with bees.RunCloudPlugin with IdeaProject{
  ...
  override def libraryDependencies = Set(
    ...
    "net.databinder" %% "dispatch-twitter" % "0.8.3" % "compile->default",
